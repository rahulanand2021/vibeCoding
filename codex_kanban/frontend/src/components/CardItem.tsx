...
export default function CardItem({ card, columnId, onEdit, onDelete }: CardItemProps) {
      ...
      <div className={styles.cardHeader}>
        ...
        <div className={styles.cardActions}>
          ...
          >
            ...
            >
              <path
                d="M4 16.75V20h3.25L17.81 9.44l-3.25-3.25L4 16.75z"
                fill="currentColor"
              />
              <path
          ...
          >
            ...
            >
              <path
                d="M6 7h12l-1 13H7L6 7zm4-3h4l1 2H9l1-2z"
                fill="currentColor"
              />
            </svg>
          </button>
